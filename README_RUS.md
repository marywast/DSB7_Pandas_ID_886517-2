...
3. [Глава III](#глава-iii)  
     3.1. [Дополнительные инструкции на сегодня](#дополнительные-инструкции-на-сегодня)
4. [Глава IV](#глава-iv)  
     4.1. [Упражнение 00. Загрузка и сохранение](#упражнение-00-загрузка-и-сохранение)
5. [Глава V](#глава-v)  
     5.1. [Упражнение 01. Базовые операции](#упражнение-01-базовые-операции)
6. [Глава VI](#глава-vi)  
     6.1. [Упражнение 02. Предобработка](#упражнение-02-предобработка-данных)
7. [Глава VII](#глава-vii)  
     7.1. [Упражнение 03. Выборки и агрегирование](#упражнение-03-выборки-и-агрегации)
8. [Глава VIII](#глава-viii)  
     8.1. [Упражнение 04. Обогащение и преобразования](#упражнение-04-обогащение-и-преобразования)
9. [Глава IX](#глава-ix)  
     9.1. [Упражнение 05. Оптимизация в Pandas](#упражнение-05-оптимизации-pandas)
...
2. Обогати DataFrame сэмплом из этого же DataFrame.
...
3. Обогати `concat_rows` новой колонкой с сгенерированными данными.
...
4. Обогати DataFrame данными из другого DataFrame.
...
5. Создай сводную таблицу (pivot table) из `fines`.
  - Она должна выглядеть как на примере ниже (значения - суммы штрафов), но со **всеми** годами. Твои значения могут отличаться.

     ![пример](misc/images/pivot-table.png)

6. Сохрани оба DataFrame - `fines` и `owners` - в CSV-файлы **без индекса**.
...
3. Индексация: время также измеряй магической командой `%%timeit` в ячейке.
...
4. Понижение разрядности типов (downcasting):
